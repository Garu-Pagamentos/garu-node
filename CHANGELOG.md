...
<!-- NOTE: npm has 1.0.0 published while this file and package.json had drifted
     to 0.16.0 (last git tag v0.15.0). Releasing as 1.1.0 to sit above what is
     actually on npm; the 0.16.0/1.0.0 entries below predate that correction. -->
